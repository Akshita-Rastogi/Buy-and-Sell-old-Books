                        ...
                        <div class="checkout__inner">
                            <div class="accordion-list">
                                <div class="accordion">
									...
									?>
									<p style="color:red">Frist Register Yourself Then Login on to same page And if you are already Register then go for login.</p>
									...
									<div class="accordion__title">
										...
										<div style="display:none;" class="accordion__body">
											<div class="bilinfo">
...
for (i = 0; i < acc.length; i++) {
  acc[i].addEventListener("click", function() {
    ...
    if (accordion__body.style.display === "block") {
